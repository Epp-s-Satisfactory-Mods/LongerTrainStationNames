...
void ULTSNGameInstanceModule::SetupMod()
{
    ...
    Widget_TrainStationClass.LoadSynchronous();
    ...
    UFunction* ubergraphFunction = Widget_TrainStationClass->FindFunctionByName(TEXT("ExecuteUbergraph_Widget_TrainStationNew"));
    //DumpFunction(ubergraphFunction, TEXT("BeforeMod"))
    TArray<uint8>& originalCode = ubergraphFunction->Script;
    ...
    //DumpFunction(ubergraphFunction, TEXT("AfterMod"));
}
